...
-- in addition, specify how they perform. specify abstract data interface
...
rest_list: (eq a) => (v: a)-> (l:list  a) -> list a 
rest_list v (h::t) = ite (eql v h) t (h::(rest_list v t))

list_remove: (eq a) => (v: a) -> (l: list a) -> list a
list_remove v nil = nil
list_remove v (h::t) = ite (member v (h::t)) (rest_list v (h::t)) (h::t)
...
combine nil l = l
combine l' nil= l'
combine (h1::t1) l1 = ite (member h1 l1) (combine t1 l1) (h1::(combine t1 l1))
...
set_intersection (mkSet l1) (mkSet l2) = mkSet (intersect l2 (intersect l1 l2))
...
list_difference l2 nil = l2
list_difference (h::t) l3 = ite (member h l3) (list_difference t l3) (h::(list_difference t l3))
...
-- Return true p is true for every v in s, otherwise false
-- set_forall: (p: a -> bool) -> (s: set a) -> bool
list_forall: (p:a-> bool) -> list a -> bool
...
-- Return true if p is true for some v in s, otherwise else false
-- set_exists: (p: a -> bool) -> (s: set a) -> bool
list_exist: (p: a -> bool) -> list a -> bool
list_exist p nil =false
list_exist p (h::t) = ite (p h) true (list_exist p t)
...
--takes an elt h and a list b and returns list of all paris, (h,e),
  --where e is an element of b 
  
make_pair: a -> list b -> list (pair a b)
make_pair t nil = nil
make_pair s (h::t) = (mkPair s h)::(make_pair s t)

--given a list of a and a list of b return a list of all a-b pairs
list_product: list a -> list b -> list (pair a b)
list_product nil l1 = nil
list_product (h1::t1) l2 = (make_pair h1 l2) ++ (list_product t1 l2)
...
-- { {}, {1}, {2}, {3}, {1, 2}, {1, 3}, {2, 3}, {1, 2, 3} }. The
-- cardinality of the powerset of a set of cardinality n is 2^n.
--single_powerset: list a -> list (set a)
--single_powerset nil = (mkSet nil)::nil
--single_powerset (h1::t1) = (mkSet (h1::nil))::(single_powerset t1)
